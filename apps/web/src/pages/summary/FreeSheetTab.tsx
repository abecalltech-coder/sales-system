    ...
    <div>
      ...
      >
        ...
        <button
          ...
          title="新しいシートを追加"
          style={{ padding: '6px 12px', fontSize: 16, border: 'none', background: 'transparent', boxShadow: 'none', cursor: 'pointer', color: 'var(--color-text-faint)' }}
        >
          ＋
        </button>
      </div>
